...
*/
    ...
    public static void main(String[] args) {
        ...
        System.out.println("str.substring(10) = " + str.substring(10)); // "korku iyidir diri tutar

        System.out.println("str.substring(str.length()-6) = " + str.substring(str.length() - 6)); //tutar
