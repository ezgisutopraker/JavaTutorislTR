...
*/
    ...
    public static void main(String[] args) {
        ...
        C02_StaticVariable.firmaName = "zararına satışlar";
        yerliMi = false;
        ...
        obj.nonStaticMethod();
        System.out.println("firmaName = " + firmaName); //nefes
        System.out.println("firmaId = " + firmaId); //3003
