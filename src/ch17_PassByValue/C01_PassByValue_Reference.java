...
veya mobilyalarında değişiklik yapar. Bu değişiklikler doğrudan
 ...
 evinize etki eder.
        ...
        //deger tipi degisken değiştrime

        incrementInt(x);
        System.out.println("method call sonrası x deger "+ x ); //10
        ...
        arttirilmisFiyat(fiyat);
        System.out.println("method call sonrası fiyat = " + fiyat);
        
    }

    private static void arttirilmisFiyat(double fiyat) {
        //fiyat *=1.24;
        int a = (int) (fiyat*0.24);
        fiyat += a;
        System.out.println("method içinden = " + fiyat);
    }
    ...
    private static void incrementInt(int x) {
        ...
        x+=10;
        System.out.println("incrementInt methodu içinden x degeri " + x); //20
    }
