...
public class C07_ComparingDateTime {
    public static void main(String[] args) {
        ...
        System.out.println("bugun.isBefore(dun) = " + bugun.isBefore(dun)); //false
        System.out.println("bugun.isBefore(yarin) = " + bugun.isBefore(yarin)); //true
        System.out.println("bugun.isAfter(yarin) = " + bugun.isAfter(yarin)); //false

        System.out.println("dogumGun.isLeapYear() = " + dogumGun.isLeapYear()); //true
