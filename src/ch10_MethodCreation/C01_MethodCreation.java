...
public class C01_MethodCreation {
    ...
    3) Bir method olusturulurken  " str.indexOf(String str, int fromIndex) "
       ...
       */
        ...
        //RUN - JVM -MAIN - ÜSTTEKİ SOUT - TOPLA METHOD ÇAĞRILDI - TOPLA ÇALIŞTI
        //JVM MAIN CALL EDİYOR- TOPLAM () DA TOPLAM METHODUNU CALL EDİYOR



        //task01 iki tnae int değer alan topayıp return eden method
    ...
    private static void topla3() {// intellij e create ettirilen method
        ...
        topla(); //METHOD CALL EDİLDİ


    }

    public static int topla2(int sayi1 , int sayi2){ //task01deki method create edildi
        int toplam = sayi1 + sayi2;
        topla();
        return toplam;
    }
    static void topla() { //method create edildi
        System.out.println("ilk create ettiğimiz method");
        int a = 55;
        int b = 44;
        System.out.println(a+b);
        System.out.println("topla isimli method çalıştı");
