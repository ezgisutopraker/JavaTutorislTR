...
public class C04_MethodOverloading {
        ...
        public static void main(String[] args) {
            ...
            System.out.println("topla(1,2,4) = " + topla(1, 2, 4)); //62

            //METHOD İSİMLERİ AYNI FAKAT METHOD SİGNATURE, PARAMETRELER, ARGUMAN SAYILARI FARKLI
    ...
    private static String topla(String a, String b) {
        System.out.println("iki pm si String olan method çalıştı");
            return a+b;
    }

    private static double topla(int i, double v) {
        System.out.println("1. pm int 2. pm double olan method");
            return i+v;
    }

    private static int topla(int i, int i1, int i2) {
        System.out.println("3 pm int olan method");
            return i+i1+i2;
    }

    private static void topla(int i, int i1) {
        System.out.println("iki pm int olan");
        System.out.println(i+i1);

    }

    private static void topla() {
        System.out.println("pmsiz method çalıştı");
        System.out.println(35+80);
