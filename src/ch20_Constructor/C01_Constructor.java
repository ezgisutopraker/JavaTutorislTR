...
public class C01_Constructor {
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        obj1.str = "javAslan"; //str instance var. 'ına obj1 ile call edilerek yeni deger atandı
        obj2.str = "javAtar";
        System.out.println("obj3.selam = " + obj3.selam); //hello World
        System.out.println("obj1.str = " + obj1.str); //javAslan
        System.out.println("obj2.str = " + obj2.str); //javAtar
        System.out.println("obj4.str = " + obj4.str); //null

        obj2.method(); //object name ile static olmyana bir method call edildi static olan main method içerisinden
        obj4.method();
    ...
    public void method(){
        System.out.println("methodtan merhaba");
