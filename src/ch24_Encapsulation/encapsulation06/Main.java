...
*/
    public static void main(String[] args) {
        ...
        int age = employee1.ageCalculater(dob);
...
class Employees {
    ...
    public int ageCalculater (String dob){ //08/23/1990
        DateTimeFormatter format = DateTimeFormatter.ofPattern("MM/dd/yyyy");
        LocalDate now = LocalDate.now();
        LocalDate dateOfbirth = LocalDate.parse(dob, format); //kullanıcının girdiği String doğum tarihini Local Date e çevirfi
