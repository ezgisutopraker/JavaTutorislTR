...
*/
    ...
    C02_Encapsulation obj1 = new C02_Encapsulation();
        ...
        System.out.println("obj1.getId() = " + obj1.getId()); //default olduğundan dolayı 0
        System.out.println("obj1.getName() = " + obj1.getName()); //null

        C02_Encapsulation obj2 = new C02_Encapsulation(1001,"rumeysa hanım");

        System.out.println("obj2.getId() = " + obj2.getId()); //1001
        System.out.println("obj2.getName() = " + obj2.getName()); //rumeysa hanım

        obj1.setName("şafak hanım");
        System.out.println("obj1.getName() = " + obj1.getName()); //şafak hanım

        obj2.setName("furkan bey");
        System.out.println("obj2.getName() = " + obj2.getName()); //furkan bey
